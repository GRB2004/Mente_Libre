  ...
  'Activo': [
    {
      ...
      imagen: 'assets/tecnicas/Exp inmediata.jpeg',
      detalles: `
        <h3>¿Qué es?</h3>
        <p>
    ...
    },
    {
      ...
      imagen: 'assets/tecnicas/Aprendizaje Coop.jpeg',
      detalles: `
        <h3>¿Qué es?</h3>
        <p>
    ...
    },
    {
      ...
      imagen: 'assets/tecnicas/Simulacion.jpeg',
      detalles: `
        <h3>¿Qué es?</h3>
        <p>
  ...
  'Reflexivo': [
    {
      ...
      imagen: 'assets/tecnicas/Observacion analitica.jpeg',
      detalles: `
        <h3>¿Qué es?</h3>
        <p>
    ...
    },
    {
      ...
      imagen: 'assets/tecnicas/Diario.jpeg',
      detalles: `
        <h3>¿Qué es?</h3>
        <p>
